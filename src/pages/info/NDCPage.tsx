            ...
            <div>
              <div className="space-y-3">
                ...
                <div className="text-sm text-gray-600 leading-relaxed">
                  ...
                  기후변화를 완화하기 위한 빠른 대응이 필요하다. 그런 측면에서
                  단기적인 시점의 온실가스 감축목표인 NDC는 매우 중요하다.
                  2050년에 탄소중립이 달성되더라도, 그 전까지 배출되어 대기중에
                  누적된 온실가스는 기후변화를 가속화시킬 수 있기 때문이다.{' '}
                </div>
              </div>
